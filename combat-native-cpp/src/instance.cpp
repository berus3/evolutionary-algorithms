...
int getStatMaxHp(int stat_point) {
    switch (instance) {
        ...
        case LINEAR: {
            float m = 20.0f;
            float n = 100.0f;
            return (int)roundf(linear(stat_point, m, n));
        }
        default:
